...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002607710343')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002522097400')  # Request channel id (make sure bot is admin)
